      ...
      <div class="row">
        <div class="col-sm">
          <label for="file" class="bold-label">Justificatif</label>
            ...
            <span id="file-name-admin">${bill.fileName !== 'null' ? bill.fileName : 'Justificatif invalide'}</span>
            <div class='icons-container'>
              <span id="icon-eye-d" data-testid="icon-eye-d" class="${bill.fileName === 'null' ? 'icon-eye-d--empty' : ''}"  data-bill-url="${bill.fileUrl}"> ${eyeWhite} </span>
            </div>
          </div>
        </div>
      </div>
